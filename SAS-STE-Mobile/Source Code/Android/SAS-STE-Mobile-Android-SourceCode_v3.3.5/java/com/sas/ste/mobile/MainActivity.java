    ...
    private void checkForFilesystem() {
        ...
        if(SDK_INT >= 30) {
            if (!Environment.isExternalStorageManager()) {
                ...
                MESIntent.setAction(Settings.ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION);
                Uri MESUri = Uri.fromParts("package", this.getPackageName(), null);
                MESIntent.setData(MESUri);
