...
public class StaticKeyGen extends AppCompatActivity {
    ...
    protected static EditText static_edittext_input_statickeys_file;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        static_edittext_input_statickeys_file = (EditText) findViewById(R.id.edittext_input_statickeys_file);
    ...
    public void buttonManagerStaticKeyGen(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_view_crr_static_keys:
                getCrrStaticKeys();
                break;
            case R.id.button_help_StaticKeyGen:
                gotoHelp();
                break;
    ...
    private void selectStaticKeysFile() {
        ...
        FileExplorerIntent.putExtra("prevAct","StaticKeyGen");
