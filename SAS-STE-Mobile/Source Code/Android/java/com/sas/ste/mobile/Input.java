...
public class Input extends AppCompatActivity {
    ...
    Button button_scan_input_text, button_select_input_file, button_back, button_next;
    ...
    private void scanText() {
        Toast.makeText(Input.this, "This Feature Is Not Available Yet. Please Enter Key Manually", Toast.LENGTH_SHORT).show();
    }

    private void selectFile() {
        Toast.makeText(Input.this, "This Feature Is Not Available Yet. Please Enter Key File Path Manually", Toast.LENGTH_SHORT).show();
    }
