...
public class KeyInput extends AppCompatActivity {
    ...
    private void scanKey() {
        Toast.makeText(KeyInput.this, "This Feature Is Only Available In The Pro Version. Please Enter Key Manually", Toast.LENGTH_SHORT).show();
    }

    private void selectKeyFile() {
        Toast.makeText(KeyInput.this, "This Feature Is Only Available In The Pro Version. Please Enter Key File Path Manually", Toast.LENGTH_SHORT).show();
    }
