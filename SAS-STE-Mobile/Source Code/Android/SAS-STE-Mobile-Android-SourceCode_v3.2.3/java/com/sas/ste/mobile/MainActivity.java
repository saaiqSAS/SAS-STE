...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkForFilesystem() {
        ...
        try {
                File mainDir = new File(Environment.getExternalStorageDirectory() + "/SAS-STE/");
                if (!mainDir.exists()) {
                    boolean createFile = mainDir.mkdirs();
                    if (createFile) {
                        Toast.makeText(MainActivity.this, "SAS-STE Created ", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Error!! SAS-STE Not Created ", Toast.LENGTH_SHORT).show();
                    }
                }
        } catch (Exception e) {
        ...
        try {
                File keysDir = new File(Environment.getExternalStorageDirectory() + "/SAS-STE/Key/");
                if (!keysDir.exists()) {
                    boolean createFile = keysDir.mkdirs();
                    if (createFile) {
                        Toast.makeText(MainActivity.this, "SAS-STE/Key Created ", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Error!! SAS-STE/Key Not Created ", Toast.LENGTH_SHORT).show();
                    }
                }
        } catch (Exception e) {
                Toast.makeText(MainActivity.this, "Error!! Couldn't Check Filesystem", Toast.LENGTH_SHORT).show();
        ...
        try {
                File outputDir = new File(Environment.getExternalStorageDirectory() + "/SAS-STE/Output/");
                if (!outputDir.exists()) {
                    boolean createFile = outputDir.mkdirs();
                    if (createFile) {
                        Toast.makeText(MainActivity.this, "SAS-STE/Output Created ", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Error!! SAS-STE/Output Not Created ", Toast.LENGTH_SHORT).show();
                    }
                }
        } catch (Exception e) {
                Toast.makeText(MainActivity.this, "Error!! Couldn't Check Filesystem", Toast.LENGTH_SHORT).show();
        ...
        try {
            File programFilesDir = new File(Environment.getExternalStorageDirectory() + "/SAS-STE/.ProgramFiles/");
    ...
    protected void getStaticKeys() {
        try {
            String tempStaticKeysFilePath = Environment.getExternalStorageDirectory() + "/SAS-STE/.ProgramFiles/StaticKeys.stkey";
